...
class Debouncer {
  ...
  Timer? _timer;
  // Store pending action so flush() can fire it immediately.
  ...
  /// Flush immediately fires the pending action (if any) without waiting
  /// for the delay to expire. Call on app background/pause so in-flight
